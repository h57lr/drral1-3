...
export const dictionary = {
  en: {
    ...
    finalCtaText: "Book your private consultation and let Dr. Ali's team guide you toward the right cosmetic treatment with clear, discreet next steps.",
  ...
  ar: {
    ...
    finalCtaText: "احجز استشارتك الخاصة ودع فريق الدكتور علي يرشدك للخطوة التجميلية الأنسب بوضوح وخصوصية.",
...
export const doctorProfileHighlight = {
  en: {
    ...
    body: "Dr. Ali Alheneiti blends precise cosmetic planning with a soft, natural aesthetic for Hollywood smiles, veneers, and smile transformations in Amman. Every new smile I design is not just a change in appearance; it is the rewriting of an entire life story in front of my eyes. Seeing a patient’s confidence return fills my heart with unmatched joy, this is my true purpose.",
  ...
  ar: {
    ...
    body: "يجمع الدكتور علي الحنيطي بين التخطيط التجميلي الدقيق والنتائج الطبيعية الراقية لابتسامات هوليوود، الفينير، وتحولات الابتسامة في عمّان. كل ابتسامة جديدة أصممها ليست مجرد تغيير في المظهر؛ بل هي إعادة كتابة لقصة حياة كاملة أمام عيني. رؤية ثقة المريض وهي تعود تملأ قلبي بفرح لا يشبهه شيء، فهذه هي رسالتي الحقيقية.",
...
export const cases: CaseMedia[] = [
  {
    ...
    type: "before-after",
    posterSrc: "/media/smile-case-images/dental-veneers-after-smile-case-jordan.webp",
  ...
  },
  {
    ...
    type: "before-after",
    posterSrc: "/media/smile-case-images/zircon-veneers-after-smile-jordan.webp",
  ...
  },
  {
    ...
    treatment: "implants",
    type: "before-after",
    posterSrc: "/media/service-images/single-tooth-implant-final-crown-result-amman.webp",
  ...
  },
  {
    ...
    type: "testimonial",
    posterSrc: "/media/video-posters/dr-ali-veneers-patient-result-poster.jpg",
...
export const blogPosts: BlogPost[] = [
  ...seoBlogPosts,
  {
    ...
    coverImage: "/media/smile-case-images/dental-veneers-after-smile-case-jordan.webp",
    ...
    faqs: [
      ...
      { question: { en: "Can I start my first step on WhatsApp?", ar: "هل يمكن بدء الخطوة الأولى عبر واتساب؟" }, answer: { en: "Yes. A private consultation helps the clinic understand your goals and guide the next step, while final diagnosis, cost, and material choice require an in-person examination.", ar: "نعم. تساعد الاستشارة الخاصة العيادة على فهم هدفك وتوجيهك للخطوة التالية، بينما يحتاج التشخيص النهائي والتكلفة واختيار المادة إلى فحص في العيادة." } }
    ]
  },
  {
    slug: "why-veneers",
    ...
    readTime: "8 min read",
    coverImage: "/media/smile-case-images/natural-veneers-before-after-comparison-closeup.webp",
  ...
  },
  {
    ...
    readTime: "8 min read",
    coverImage: "/media/doctor-profile/dr-ali-alheneiti-cosmetic-dentist-amman-jordan.webp",
  ...
  },
  {
    ...
    readTime: "10 min read",
    coverImage: "/media/service-images/dental-tourism-jordan-travel-planning.webp",
